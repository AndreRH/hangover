...
struct qemu_d3d_device7_GetRenderTarget
{
    struct qemu_syscall super;
    uint64_t iface;
...
{
    struct qemu_d3d_device7_GetRenderTarget call;
    struct qemu_device *device = impl_from_IDirect3DDevice7(iface);
    call.super.id = QEMU_SYSCALL_ID(CALL_D3D_DEVICE7_GETRENDERTARGET);
    call.iface = (ULONG_PTR)device;
    call.RenderTarget = (ULONG_PTR)RenderTarget;
...
{
    struct qemu_d3d_device7_GetRenderTarget *c = (struct qemu_d3d_device7_GetRenderTarget *)call;
    struct qemu_device *device;

    WINE_FIXME("Unverified!\n");
    device = QEMU_G2H(c->iface);

    c->super.iret = IDirect3DDevice7_GetRenderTarget(device->host7, QEMU_G2H(c->RenderTarget));
}

#endif

struct qemu_d3d_device3_GetRenderTarget
{
    struct qemu_syscall super;
    uint64_t iface;
    uint64_t RenderTarget;
...
{
    struct qemu_d3d_device3_GetRenderTarget call;
    struct qemu_device *device = impl_from_IDirect3DDevice3(iface);
    call.super.id = QEMU_SYSCALL_ID(CALL_D3D_DEVICE3_GETRENDERTARGET);
    call.iface = (ULONG_PTR)device;
    call.RenderTarget = (ULONG_PTR)RenderTarget;
...
{
    struct qemu_d3d_device3_GetRenderTarget *c = (struct qemu_d3d_device3_GetRenderTarget *)call;
    struct qemu_device *device;

    WINE_FIXME("Unverified!\n");
    device = QEMU_G2H(c->iface);

    c->super.iret = IDirect3DDevice3_GetRenderTarget(device->host3, QEMU_G2H(c->RenderTarget));
}

#endif

struct qemu_d3d_device2_GetRenderTarget
{
    struct qemu_syscall super;
    uint64_t iface;
    uint64_t RenderTarget;
...
{
    struct qemu_d3d_device2_GetRenderTarget call;
    struct qemu_device *device = impl_from_IDirect3DDevice2(iface);
    call.super.id = QEMU_SYSCALL_ID(CALL_D3D_DEVICE2_GETRENDERTARGET);
    call.iface = (ULONG_PTR)device;
    call.RenderTarget = (ULONG_PTR)RenderTarget;
...
{
    struct qemu_d3d_device2_GetRenderTarget *c = (struct qemu_d3d_device2_GetRenderTarget *)call;
    struct qemu_device *device;

    WINE_FIXME("Unverified!\n");
    device = QEMU_G2H(c->iface);

    c->super.iret = IDirect3DDevice2_GetRenderTarget(device->host2, QEMU_G2H(c->RenderTarget));
}
...
static HRESULT WINAPI d3d_device7_DrawPrimitive(IDirect3DDevice7 *iface, D3DPRIMITIVETYPE primitive_type, DWORD fvf, void *vertices, DWORD vertex_count, DWORD flags)
{
...
void qemu_d3d_device7_DrawPrimitive(struct qemu_syscall *call)
{
    ...
    c->super.iret = IDirect3DDevice7_DrawPrimitive(device->host7, c->primitive_type, c->fvf, QEMU_G2H(c->vertices), c->vertex_count, c->flags);
}
...
void qemu_d3d_device3_DrawPrimitive(struct qemu_syscall *call)
{
    ...
    c->super.iret = IDirect3DDevice3_DrawPrimitive(device->host3, c->primitive_type, c->fvf, QEMU_G2H(c->vertices), c->vertex_count, c->flags);
}
...
void qemu_d3d_device2_DrawPrimitive(struct qemu_syscall *call)
{
    ...
    c->super.iret = IDirect3DDevice2_DrawPrimitive(device->host2, c->primitive_type, c->vertex_type, QEMU_G2H(c->vertices), c->vertex_count, c->flags);
}
...
static HRESULT WINAPI d3d_device7_DrawIndexedPrimitive(IDirect3DDevice7 *iface, D3DPRIMITIVETYPE primitive_type, DWORD fvf, void *vertices, DWORD vertex_count, WORD *indices, DWORD index_count, DWORD flags)
{
...
static HRESULT WINAPI d3d_device7_DrawPrimitiveStrided(IDirect3DDevice7 *iface, D3DPRIMITIVETYPE PrimitiveType, DWORD VertexType, D3DDRAWPRIMITIVESTRIDEDDATA *D3DDrawPrimStrideData, DWORD VertexCount, DWORD Flags)
{
...
void qemu_d3d_device7_DrawPrimitiveStrided(struct qemu_syscall *call)
{
    ...
    c->super.iret = IDirect3DDevice7_DrawPrimitiveStrided(device->host7, c->PrimitiveType, c->VertexType, QEMU_G2H(c->D3DDrawPrimStrideData), c->VertexCount, c->Flags);
}
...
void qemu_d3d_device3_DrawPrimitiveStrided(struct qemu_syscall *call)
{
    ...
    c->super.iret = IDirect3DDevice3_DrawPrimitiveStrided(device->host3, c->PrimitiveType, c->VertexType, QEMU_G2H(c->D3DDrawPrimStrideData), c->VertexCount, c->Flags);
}
...
static HRESULT WINAPI d3d_device7_DrawIndexedPrimitiveVB(IDirect3DDevice7 *iface, D3DPRIMITIVETYPE PrimitiveType, IDirect3DVertexBuffer7 *D3DVertexBuf, DWORD StartVertex, DWORD NumVertices, WORD *Indices, DWORD IndexCount, DWORD Flags)
{
...
void qemu_d3d_device7_DrawIndexedPrimitiveVB(struct qemu_syscall *call)
{
    ...
    c->super.iret = IDirect3DDevice7_DrawIndexedPrimitiveVB(device->host7, c->PrimitiveType, QEMU_G2H(c->D3DVertexBuf), c->StartVertex, c->NumVertices, QEMU_G2H(c->Indices), c->IndexCount, c->Flags);
}
...
void qemu_d3d_device3_DrawIndexedPrimitiveVB(struct qemu_syscall *call)
{
    ...
    c->super.iret = IDirect3DDevice3_DrawIndexedPrimitiveVB(device->host3, c->PrimitiveType, QEMU_G2H(c->D3DVertexBuf), QEMU_G2H(c->Indices), c->IndexCount, c->Flags);
}
