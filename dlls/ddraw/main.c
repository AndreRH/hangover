...
static const syscall_handler dll_functions[] =
{
    ...
    qemu_d3d_device1_EnumTextureFormats,
    qemu_d3d_device1_Execute,
    qemu_d3d_device1_GetCaps,
    qemu_d3d_device1_GetDirect3D,
    ...
    qemu_d3d_device7_GetRenderTarget,
    ...
    qemu_ddraw_surface1_GetAttachedSurface,
    ...
    qemu_ddraw_surface2_GetAttachedSurface,
    ...
    qemu_ddraw_surface3_GetAttachedSurface,
    ...
    qemu_ddraw_surface4_GetAttachedSurface,
    ...
    qemu_ddraw_surface7_GetAttachedSurface,
