...
static const syscall_handler dll_functions[] =
{
    ...
    qemu_d3d_CreateLight,
    qemu_d3d_CreateMaterial,
    qemu_d3d_CreateViewport,
    qemu_d3d_EnumDevices,
    ...
    qemu_d3d_execute_buffer_GetExecuteData,
    qemu_d3d_execute_buffer_Initialize,
    qemu_d3d_execute_buffer_Lock,
    qemu_d3d_execute_buffer_Optimize,
    qemu_d3d_execute_buffer_Release,
    qemu_d3d_execute_buffer_SetExecuteData,
    qemu_d3d_execute_buffer_Unlock,
    qemu_d3d_execute_buffer_Validate,
    qemu_d3d_light_GetLight,
    qemu_d3d_light_Initialize,
    qemu_d3d_light_Release,
    qemu_d3d_light_SetLight,
    qemu_d3d_material1_GetHandle,
    qemu_d3d_material1_GetMaterial,
    qemu_d3d_material1_Initialize,
    qemu_d3d_material1_Release,
    qemu_d3d_material1_Reserve,
    qemu_d3d_material1_SetMaterial,
    qemu_d3d_material1_Unreserve,
    qemu_d3d_material2_GetHandle,
    qemu_d3d_material2_GetMaterial,
    qemu_d3d_material2_SetMaterial,
    qemu_d3d_material3_GetHandle,
    qemu_d3d_material3_GetMaterial,
    qemu_d3d_material3_SetMaterial,
    ...
    qemu_d3d_viewport_AddLight,
    qemu_d3d_viewport_Clear,
    qemu_d3d_viewport_Clear2,
    qemu_d3d_viewport_DeleteLight,
    qemu_d3d_viewport_GetBackground,
    qemu_d3d_viewport_GetBackgroundDepth,
    qemu_d3d_viewport_GetBackgroundDepth2,
    qemu_d3d_viewport_GetViewport,
    qemu_d3d_viewport_GetViewport2,
    qemu_d3d_viewport_Initialize,
    qemu_d3d_viewport_LightElements,
    qemu_d3d_viewport_NextLight,
    qemu_d3d_viewport_Release,
    qemu_d3d_viewport_SetBackground,
    qemu_d3d_viewport_SetBackgroundDepth,
    qemu_d3d_viewport_SetBackgroundDepth2,
    qemu_d3d_viewport_SetViewport,
    qemu_d3d_viewport_SetViewport2,
    qemu_d3d_viewport_TransformVertices,
    qemu_ddraw1_Compact,
    qemu_ddraw_CreatePalette,
    qemu_ddraw1_CreateSurface,
    qemu_ddraw1_DuplicateSurface,
    qemu_ddraw_EnumSurfaces,
