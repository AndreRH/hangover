 ...
 *           wvsprintfA   (USER32.@)
 */
WINBASEAPI INT wvsprintfA( LPSTR buffer, LPCSTR spec, va_list args )
{
 ...
 *           wvsprintfW   (USER32.@)
 */
WINBASEAPI INT wvsprintfW( LPWSTR buffer, LPCWSTR spec, va_list args )
{
 ...
 *           wsprintfA   (USER32.@)
 */
WINUSERAPI INT WINAPIV wsprintfA(LPSTR buffer, LPCSTR spec, ...)
{
    va_list valist;
    INT res;
 ...
 *           wsprintfW   (USER32.@)
 */
WINUSERAPI int WINAPIV wsprintfW(LPWSTR buffer, LPCWSTR spec, ...)
{
    va_list valist;
    INT res;
