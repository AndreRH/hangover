...
void qemu_CharNextA(struct qemu_syscall *call)
{
    ...
    c->super.iret = (uint64_t)CharNextA(QEMU_G2H(c->ptr));
}
...
void qemu_CharNextExA(struct qemu_syscall *call)
{
    ...
    WINE_FIXME("Unverified!\n");
    c->super.iret = (uint64_t)CharNextExA(c->codepage, QEMU_G2H(c->ptr), c->flags);
}
...
void qemu_CharNextExW(struct qemu_syscall *call)
{
    ...
    WINE_FIXME("Unverified!\n");
    c->super.iret = (uint64_t)CharNextExW(c->codepage, QEMU_G2H(c->ptr), c->flags);
}
...
void qemu_CharNextW(struct qemu_syscall *call)
{
    ...
    WINE_FIXME("Unverified!\n");
    c->super.iret = (uint64_t)CharNextW(QEMU_G2H(c->x));
}
...
void qemu_CharPrevA(struct qemu_syscall *call)
{
    ...
    WINE_FIXME("Unverified!\n");
    c->super.iret = (uint64_t)CharPrevA(QEMU_G2H(c->start), QEMU_G2H(c->ptr));
}
...
void qemu_CharPrevExA(struct qemu_syscall *call)
{
    ...
    WINE_FIXME("Unverified!\n");
    c->super.iret = (uint64_t)CharPrevExA(c->codepage, QEMU_G2H(c->start), QEMU_G2H(c->ptr), c->flags);
}
...
void qemu_CharPrevExW(struct qemu_syscall *call)
{
    ...
    WINE_FIXME("Unverified!\n");
    c->super.iret = (uint64_t)CharPrevExW(c->codepage, QEMU_G2H(c->start), QEMU_G2H(c->ptr), c->flags);
}
...
void qemu_CharPrevW(struct qemu_syscall *call)
{
    ...
    WINE_FIXME("Unverified!\n");
    c->super.iret = (uint64_t)CharPrevW(QEMU_G2H(c->start), QEMU_G2H(c->x));
}
...
void qemu_CharLowerA(struct qemu_syscall *call)
{
    ...
    WINE_TRACE("\n");
    c->super.iret = (uint64_t)CharLowerA(QEMU_G2H(c->str));
}
...
void qemu_CharUpperA(struct qemu_syscall *call)
{
    ...
    WINE_TRACE("\n");
    c->super.iret = (uint64_t)CharUpperA(QEMU_G2H(c->str));
}
...
void qemu_CharLowerW(struct qemu_syscall *call)
{
    ...
    WINE_FIXME("Unverified!\n");
    c->super.iret = (uint64_t)CharLowerW(QEMU_G2H(c->str));
}
...
void qemu_CharUpperW(struct qemu_syscall *call)
{
    ...
    WINE_FIXME("Unverified!\n");
    c->super.iret = (uint64_t)CharUpperW(QEMU_G2H(c->str));
}
