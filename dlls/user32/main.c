...
static const syscall_handler dll_functions[] =
{
    ...
    qemu_AppendMenuA,
    qemu_AppendMenuW,
    qemu_AreDpiAwarenessContextsEqual,
    ...
    qemu_GetAwarenessFromDpiAwarenessContext,
    qemu_GetCapture,
    ...
    qemu_GetDpiForMonitorInternal,
    qemu_GetDpiForSystem,
    qemu_GetDpiForWindow,
    qemu_GetFocus,
    ...
    qemu_GetWindowDC,
    qemu_GetWindowDisplayAffinity,
    qemu_GetWindowDpiAwarenessContext,
    qemu_GetWindowInfo,
    qemu_GetWindowLongA,
    ...
    qemu_IsRectEmpty,
    qemu_IsTouchWindow,
    qemu_IsValidDpiAwarenessContext,
    qemu_IsWindow,
    ...
    qemu_LogicalToPhysicalPointForPerMonitorDPI,
    ...
    qemu_PhysicalToLogicalPointForPerMonitorDPI,
    qemu_PostMessageA,
    qemu_PostMessageW,
    ...
    qemu_RegisterPointerDeviceNotifications,
    ...
    qemu_RegisterTouchHitTestingWindow,
    ...
    qemu_SystemParametersInfo,
    qemu_SystemParametersInfoForDpi,
    qemu_TabbedTextOutA,
    qemu_TabbedTextOutW,
