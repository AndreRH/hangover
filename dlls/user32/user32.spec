...
@ stdcall DdeSetUserHandle (long long long) user32_DdeSetUserHandle
...
@ stdcall GetClassLongA(long long) user32_GetClassLongA
@ stdcall GetClassLongW(long long) user32_GetClassLongW
...
@ stdcall -arch=win64 GetWindowLongPtrA(long long) user32_GetWindowLongPtrA
@ stdcall -arch=win64 GetWindowLongPtrW(long long) user32_GetWindowLongPtrW
...
@ stdcall SetClassLongA(long long long) user32_SetClassLongA
@ stdcall -arch=win64 SetClassLongPtrA(long long long) user32_SetClassLongPtrA
@ stdcall -arch=win64 SetClassLongPtrW(long long long) user32_SetClassLongPtrW
@ stdcall SetClassLongW(long long long) user32_SetClassLongW
...
@ stdcall -arch=win64 SetWindowLongPtrA(long long long) user32_SetWindowLongPtrA
@ stdcall -arch=win64 SetWindowLongPtrW(long long long) user32_SetWindowLongPtrW
...
@ stdcall UserClientDllInitialize(long long ptr) DllMainCRTStartup
...
@ stdcall wvsprintfA(ptr str ptr) user32_wvsprintfA
@ stdcall wvsprintfW(ptr wstr ptr) user32_wvsprintfW
