...
enum user32_calls
{
    ...
    CALL_CHANGEWINDOWMESSAGEFILTEREX,
    CALL_CHARLOWERA,
    CALL_CHARLOWERBUFFA,
    CALL_CHARLOWERBUFFW,
    CALL_CHARLOWERW,
    ...
    CALL_DISPLAYCONFIGGETDEVICEINFO,
    CALL_DLGDIRLISTA,
    ...
    CALL_GETDISPLAYAUTOROTATIONPREFERENCES,
    ...
    CALL_GETMENU,
    CALL_GETMENUBARINFO,
    CALL_GETMENUCHECKMARKDIMENSIONS,
