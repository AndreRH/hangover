...
enum ntdll_calls
{
    ...
    CALL_LDRREMOVEDLLDIRECTORY,
    CALL_LDRRESOLVEDELAYLOADEDAPI,
    CALL_LDRSETDEFAULTDLLDIRECTORIES,
    CALL_LDRSETDLLDIRECTORY,
    ...
    CALL_NTALLOCATEVIRTUALMEMORYEX,
    ...
    CALL_RTLDOSPATHNAMETONTPATHNAME_U_WITHSTATUS,
    ...
    CALL_RTLGETENABLEDEXTENDEDFEATURES,
    CALL_RTLGETEXEPATH,
    CALL_RTLGETEXTENDEDCONTEXTLENGTH2,
    CALL_RTLGETEXTENDEDFEATURESMASK,
    ...
    CALL_RTLINITIALIZEEXTENDEDCONTEXT2,
    ...
    CALL_RTLLOCATEEXTENDEDFEATURE,
    CALL_RTLLOCATEEXTENDEDFEATURE2,
    CALL_RTLLOCKHEAP,
    ...
    CALL_RTLPROCESSFLSDATA,
    CALL_RTLPUNWAITCRITICALSECTION,
    CALL_RTLPWAITFORCRITICALSECTION,
    CALL_RTLQUERYACTIVATIONCONTEXTAPPLICATIONSETTINGS,
    ...
    CALL_RTLSETEXTENDEDFEATURESMASK,
    ...
    CALL_RTLWAITONADDRESS,
    CALL_RTLWAKEADDRESSALL,
    CALL_RTLWAKEADDRESSSINGLE,
    ...
    CALL_TPISTIMERSET,
    CALL_TPPOSTWORK,
    CALL_TPQUERYPOOLSTACKINFORMATION,
    ...
    CALL_TPSETPOOLSTACKINFORMATION,
    CALL_TPSETTIMER,
    CALL_TPSETWAIT,
