...
@ stdcall NtRaiseException(ptr ptr long) ntdll_NtRaiseException
...
@ stdcall NtTerminateProcess(long long) ntdll_NtTerminateProcess
...
# @ stub RtlCancelTimer
@ stdcall -norelay RtlCaptureContext(ptr) ntdll_RtlCaptureContext
...
@ stdcall RtlFillMemory(ptr long long) ntdll_RtlFillMemory
...
@ stdcall RtlRaiseStatus(long) ntdll_RtlRaiseStatus
...
@ stdcall -arch=x86_64 -norelay RtlUnwind(ptr ptr ptr ptr) ntdll_RtlUnwind
...
@ stub RtlZeroHeap
@ stdcall RtlZeroMemory(ptr long) ntdll_RtlZeroMemory
...
@ stdcall -private ZwRaiseException(ptr ptr long) ntdll_NtRaiseException
...
@ stdcall -private ZwTerminateProcess(long long) ntdll_NtTerminateProcess
...
# @ cdecl -private iswxdigit(long) NTDLL_iswxdigitfpow
