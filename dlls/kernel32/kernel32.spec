...
@ stdcall ExitProcess(long) kernel32_ExitProcess
...
@ stdcall GetEnvironmentStrings() qemu_GetEnvironmentStringsA
@ stdcall GetEnvironmentStringsA() qemu_GetEnvironmentStringsA
...
@ stdcall GetModuleHandleW(wstr) kernel32_GetModuleHandleW
...
@ stdcall GetProcAddress(long str) kernel32_GetProcAddress
...
@ stdcall RaiseException(long long long ptr) kernel32_RaiseException
...
@ stdcall UnhandledExceptionFilter(ptr) kernel32_UnhandledExceptionFilter
