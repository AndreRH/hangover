...
static const syscall_handler dll_functions[] =
{
    ...
    qemu_DirectSoundFullDuplexRelease,
    ...
    qemu_IDirectSoundCaptureBufferImpl_GetCaps,
    qemu_IDirectSoundCaptureBufferImpl_GetCurrentPosition,
    qemu_IDirectSoundCaptureBufferImpl_GetFormat,
    qemu_IDirectSoundCaptureBufferImpl_GetFXStatus,
    qemu_IDirectSoundCaptureBufferImpl_GetObjectInPath,
    qemu_IDirectSoundCaptureBufferImpl_GetStatus,
    qemu_IDirectSoundCaptureBufferImpl_Initialize,
    qemu_IDirectSoundCaptureBufferImpl_Lock,
    qemu_IDirectSoundCaptureBufferImpl_Release,
    qemu_IDirectSoundCaptureBufferImpl_Start,
    qemu_IDirectSoundCaptureBufferImpl_Stop,
    qemu_IDirectSoundCaptureBufferImpl_Unlock,
    qemu_IDirectSoundCaptureImpl_CreateCaptureBuffer,
    qemu_IDirectSoundCaptureImpl_GetCaps,
    qemu_IDirectSoundCaptureImpl_Initialize,
    qemu_IDirectSoundCaptureImpl_Release,
    qemu_IDirectSoundNotifyImpl_Capture_SetNotificationPositions,
