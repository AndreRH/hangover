...
static const syscall_handler dll_functions[] =
{
    ...
    qemu_midiStreamStop,
    qemu_mixerClose,
    qemu_mixerGetControlDetailsA,
    qemu_mixerGetControlDetailsW,
    qemu_mixerGetDevCapsA,
    qemu_mixerGetDevCapsW,
    qemu_mixerGetID,
    qemu_mixerGetLineControlsA,
    qemu_mixerGetLineControlsW,
    ...
    qemu_waveInMessage,
    qemu_waveInOpen,
    qemu_waveInPrepareHeader,
    qemu_waveInReset,
    qemu_waveInStart,
    qemu_waveInStop,
    qemu_waveInUnprepareHeader,
