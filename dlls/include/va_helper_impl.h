                       ...
                       unsigned int fcount, struct va_array *array)
{
    ...
    if (ffi_prep_cif_var(&cif, FFI_DEFAULT_ABI, 1, icount + 1, &ffi_type_uint64, arg_types) != FFI_OK)
        return 0;
                        ...
                        unsigned int icount, unsigned int fcount, struct va_array *array)
{
    ...
    if (ffi_prep_cif_var(&cif, FFI_DEFAULT_ABI, 2, icount + 2, &ffi_type_uint64, arg_types) != FFI_OK)
        return 0;
