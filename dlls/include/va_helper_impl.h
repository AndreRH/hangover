...
uint64_t WINAPIV call_va(uint64_t (* WINAPIV func)(void *ctx, ...), void *ctx, unsigned int icount, struct va_array *array)
{
...
uint64_t WINAPIV call_va2(uint64_t (* WINAPIV func)(void *fixed1, void *fixed2, ...), void *fixed1, void *fixed2,
