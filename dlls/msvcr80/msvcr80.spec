...
#@ thiscall -arch=i386 ??0bad_typeid@std@@QAE@ABV01@@Z(ptr ptr) __thiscall_MSVCRT_bad_typeid_copy_ctor
#@ cdecl -arch=win64 ??0bad_typeid@std@@QEAA@AEBV01@@Z(ptr ptr) __thiscall_MSVCRT_bad_typeid_copy_ctor
...
@ extern -arch=x86_64 __argc msvcr80.__qemu_native_data__
@ extern -arch=i386 __argv MSVCRT___argv
@ extern -arch=x86_64 __argv msvcr80.__qemu_native_data__
...
@ extern __mb_cur_max msvcr80.__qemu_native_data__
...
@ extern _pctype msvcr80.__qemu_native_data__
