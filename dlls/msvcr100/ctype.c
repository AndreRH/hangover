...
WINBASEAPI unsigned short** CDECL MSVCRT___p__pctype(void)
{
    ...
    return (unsigned short **)(ULONG_PTR)call.super.iret;
}
...
{
    struct qemu___p__pctype *c = (struct qemu___p__pctype *)(ULONG_PTR)call;
...
{
    struct qemu___pctype_func *c = (struct qemu___pctype_func *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__isctype_l *c = (struct qemu__isctype_l *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__isctype *c = (struct qemu__isctype *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__isalnum_l *c = (struct qemu__isalnum_l *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_isalnum *c = (struct qemu_isalnum *)(ULONG_PTR)call;
    WINE_TRACE("\n");
...
{
    struct qemu__isalpha_l *c = (struct qemu__isalpha_l *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_isalpha *c = (struct qemu_isalpha *)(ULONG_PTR)call;
    WINE_TRACE("\n");
...
{
    struct qemu__iscntrl_l *c = (struct qemu__iscntrl_l *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_iscntrl *c = (struct qemu_iscntrl *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__isdigit_l *c = (struct qemu__isdigit_l *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_isdigit *c = (struct qemu_isdigit *)(ULONG_PTR)call;
    WINE_TRACE("\n");
...
{
    struct qemu__isgraph_l *c = (struct qemu__isgraph_l *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_isgraph *c = (struct qemu_isgraph *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__isleadbyte_l *c = (struct qemu__isleadbyte_l *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_isleadbyte *c = (struct qemu_isleadbyte *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__islower_l *c = (struct qemu__islower_l *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_islower *c = (struct qemu_islower *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__isprint_l *c = (struct qemu__isprint_l *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_isprint *c = (struct qemu_isprint *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_ispunct *c = (struct qemu_ispunct *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__isspace_l *c = (struct qemu__isspace_l *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_isspace *c = (struct qemu_isspace *)(ULONG_PTR)call;
    WINE_TRACE("\n");
...
{
    struct qemu__isupper_l *c = (struct qemu__isupper_l *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_isupper *c = (struct qemu_isupper *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__isxdigit_l *c = (struct qemu__isxdigit_l *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_isxdigit *c = (struct qemu_isxdigit *)(ULONG_PTR)call;
    WINE_TRACE("\n");
...
{
    struct qemu__isblank_l *c = (struct qemu__isblank_l *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_isblank *c = (struct qemu_isblank *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu___isascii *c = (struct qemu___isascii *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu___toascii *c = (struct qemu___toascii *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_iswascii *c = (struct qemu_iswascii *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu___iscsym *c = (struct qemu___iscsym *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu___iscsymf *c = (struct qemu___iscsymf *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__toupper_l *c = (struct qemu__toupper_l *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_toupper *c = (struct qemu_toupper *)(ULONG_PTR)call;
    WINE_TRACE("\n");
...
{
    struct qemu__toupper *c = (struct qemu__toupper *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__tolower_l *c = (struct qemu__tolower_l *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_tolower *c = (struct qemu_tolower *)(ULONG_PTR)call;
    WINE_TRACE("\n");
...
{
    struct qemu__tolower *c = (struct qemu__tolower *)(ULONG_PTR)call;
    WINE_FIXME("Unverified!\n");
