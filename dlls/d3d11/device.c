...
static void STDMETHODCALLTYPE d3d10_device_ResolveSubresource(ID3D10Device1 *iface, ID3D10Resource *dst_resource,
        UINT dst_subresource_idx, ID3D10Resource *src_resource, UINT src_subresource_idx, DXGI_FORMAT format)
{
...
void qemu_d3d10_device_ResolveSubresource(struct qemu_syscall *call)
{
    ...
    ID3D10Device1_ResolveSubresource(device->host_d3d10, dst, c->dst_subresource_idx,
            src, c->src_subresource_idx, c->format);
}
