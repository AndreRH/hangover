...
static const syscall_handler dll_functions[] =
{
    ...
    qemu_FolderView2_DoRename,
    qemu_FolderView2_GetCurrentFolderFlags,
    qemu_FolderView2_GetGroupBy,
    qemu_FolderView2_GetGroupSubsetCount,
    qemu_FolderView2_GetItem,
    qemu_FolderView2_GetSelectedItem,
    qemu_FolderView2_GetSelection,
    qemu_FolderView2_GetSelectionState,
    qemu_FolderView2_GetSortColumnCount,
    qemu_FolderView2_GetSortColumns,
    qemu_FolderView2_GetViewModeAndIconSize,
    qemu_FolderView2_GetViewProperty,
    qemu_FolderView2_GetVisibleItem,
    qemu_FolderView2_InvokeVerbOnSelection,
    qemu_FolderView2_IsMoveInSameFolder,
    qemu_FolderView2_SetCurrentFolderFlags,
    qemu_FolderView2_SetExtendedTileViewProperties,
    qemu_FolderView2_SetGroupBy,
    qemu_FolderView2_SetGroupSubsetCount,
    qemu_FolderView2_SetRedraw,
    qemu_FolderView2_SetSortColumns,
    qemu_FolderView2_SetText,
    qemu_FolderView2_SetTileViewProperties,
    qemu_FolderView2_SetViewModeAndIconSize,
    qemu_FolderView2_SetViewProperty,
    qemu_FolderView_AddRef,
    qemu_FolderView_GetAutoArrange,
    qemu_FolderView_GetCurrentViewMode,
    qemu_FolderView_GetDefaultSpacing,
    qemu_FolderView_GetFocusedItem,
    qemu_FolderView_GetFolder,
    qemu_FolderView_GetItemPosition,
    qemu_FolderView_GetSelectionMarkedItem,
    qemu_FolderView_GetSpacing,
    qemu_FolderView_Item,
    qemu_FolderView_ItemCount,
    qemu_FolderView_Items,
    qemu_FolderView_QueryInterface,
    qemu_FolderView_Release,
    qemu_FolderView_SelectAndPositionItems,
    qemu_FolderView_SelectItem,
    qemu_FolderView_SetCurrentViewMode,
    qemu_FreeIconList,
    ...
    qemu_IShellFolderView_AddObject,
    qemu_IShellFolderView_AddRef,
    qemu_IShellFolderView_ArrangeGrid,
    qemu_IShellFolderView_AutoArrange,
    qemu_IShellFolderView_GetArrangeParam,
    qemu_IShellFolderView_GetAutoArrange,
    qemu_IShellFolderView_GetDragPoint,
    qemu_IShellFolderView_GetDropPoint,
    qemu_IShellFolderView_GetItemSpacing,
    qemu_IShellFolderView_GetObject,
    qemu_IShellFolderView_GetObjectCount,
    qemu_IShellFolderView_GetSelectedCount,
    qemu_IShellFolderView_GetSelectedObjects,
    qemu_IShellFolderView_IsBkDropTarget,
    qemu_IShellFolderView_IsDropOnSource,
    qemu_IShellFolderView_MoveIcons,
    qemu_IShellFolderView_QueryInterface,
    qemu_IShellFolderView_QuerySupport,
    qemu_IShellFolderView_Rearrange,
    qemu_IShellFolderView_RefreshObject,
    qemu_IShellFolderView_Release,
    qemu_IShellFolderView_RemoveObject,
    qemu_IShellFolderView_Select,
    qemu_IShellFolderView_SetAutomationObject,
    qemu_IShellFolderView_SetCallback,
    qemu_IShellFolderView_SetClipboard,
    qemu_IShellFolderView_SetItemPos,
    qemu_IShellFolderView_SetObjectCount,
    qemu_IShellFolderView_SetPoints,
    qemu_IShellFolderView_SetRedraw,
    qemu_IShellFolderView_UpdateObject,
    qemu_IShellView2_CreateViewWindow2,
    qemu_IShellView2_GetView,
    qemu_IShellView2_HandleRename,
    qemu_IShellView2_SelectAndPositionItem,
    qemu_IShellView3_CreateViewWindow3,
    qemu_IShellView_AddPropertySheetPages,
    qemu_IShellView_AddRef,
    qemu_IShellView_ContextSensitiveHelp,
    qemu_IShellView_CreateViewWindow,
    qemu_IShellView_DestroyViewWindow,
    qemu_IShellView_EnableModeless,
    qemu_IShellView_GetCurrentInfo,
    qemu_IShellView_GetItemObject,
    qemu_IShellView_GetWindow,
    qemu_IShellView_QueryInterface,
    qemu_IShellView_Refresh,
    qemu_IShellView_Release,
    qemu_IShellView_SaveViewState,
    qemu_IShellView_SelectItem,
    qemu_IShellView_TranslateAccelerator,
    qemu_IShellView_UIActivate,
    qemu_IsLFNDriveA,
    qemu_IsLFNDriveAW,
    qemu_IsLFNDriveW,
    qemu_IsNetDrive,
    qemu_IsUserAnAdmin,
    qemu_ISVDropSource_AddRef,
    qemu_ISVDropSource_GiveFeedback,
    qemu_ISVDropSource_QueryContinueDrag,
    qemu_ISVDropSource_QueryInterface,
    qemu_ISVDropSource_Release,
    qemu_ISVDropTarget_AddRef,
    qemu_ISVDropTarget_DragEnter,
    qemu_ISVDropTarget_DragLeave,
    qemu_ISVDropTarget_DragOver,
    qemu_ISVDropTarget_Drop,
    qemu_ISVDropTarget_QueryInterface,
    qemu_ISVDropTarget_Release,
    qemu_ISVOleCmdTarget_AddRef,
    qemu_ISVOleCmdTarget_Exec,
    qemu_ISVOleCmdTarget_QueryInterface,
    qemu_ISVOleCmdTarget_QueryStatus,
    qemu_ISVOleCmdTarget_Release,
    qemu_ISVViewObject_AddRef,
    qemu_ISVViewObject_Draw,
    qemu_ISVViewObject_Freeze,
    qemu_ISVViewObject_GetAdvise,
    qemu_ISVViewObject_GetColorSet,
    qemu_ISVViewObject_QueryInterface,
    qemu_ISVViewObject_Release,
    qemu_ISVViewObject_SetAdvise,
    qemu_ISVViewObject_Unfreeze,
    ...
    qemu_PersistPropertyBag_GetClassID,
    qemu_PersistPropertyBag_InitNew,
    qemu_PersistPropertyBag_Load,
    qemu_PersistPropertyBag_Save,
    qemu_PickIconDlg,
    ...
    qemu_ShellExecuteW,
    qemu_shellfolderviewdual_AddRef,
    qemu_shellfolderviewdual_FilterView,
    qemu_shellfolderviewdual_get_Application,
    qemu_shellfolderviewdual_get_CurrentViewMode,
    qemu_shellfolderviewdual_get_FocusedItem,
    qemu_shellfolderviewdual_get_Folder,
    qemu_shellfolderviewdual_get_FolderFlags,
    qemu_shellfolderviewdual_get_GroupBy,
    qemu_shellfolderviewdual_get_IconSize,
    qemu_shellfolderviewdual_get_Parent,
    qemu_shellfolderviewdual_get_Script,
    qemu_shellfolderviewdual_get_SortColumns,
    qemu_shellfolderviewdual_get_ViewOptions,
    qemu_shellfolderviewdual_GetIDsOfNames,
    qemu_shellfolderviewdual_GetTypeInfo,
    qemu_shellfolderviewdual_GetTypeInfoCount,
    qemu_shellfolderviewdual_Invoke,
    qemu_shellfolderviewdual_PopupItemMenu,
    qemu_shellfolderviewdual_put_CurrentViewMode,
    qemu_shellfolderviewdual_put_FolderFlags,
    qemu_shellfolderviewdual_put_GroupBy,
    qemu_shellfolderviewdual_put_IconSize,
    qemu_shellfolderviewdual_put_SortColumns,
    qemu_shellfolderviewdual_QueryInterface,
    qemu_shellfolderviewdual_Release,
    qemu_shellfolderviewdual_SelectedItems,
    qemu_shellfolderviewdual_SelectItem,
    qemu_shellfolderviewdual_SelectItemRelative,
    qemu_ShellHookProc,
