...
static const syscall_handler dll_functions[] =
{
    ...
    qemu_IPersistFolder2_AddRef,
    qemu_IPersistFolder2_GetClassID,
    qemu_IPersistFolder2_GetCurFolder,
    qemu_IPersistFolder2_Initialize,
    qemu_IPersistFolder2_QueryInterface,
    qemu_IPersistFolder2_Release,
