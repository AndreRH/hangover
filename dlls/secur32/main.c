...
static const syscall_handler dll_functions[] =
{
    ...
    qemu_InitializeSecurityContextA,
    qemu_InitializeSecurityContextW,
    ...
    qemu_MakeSignature,
    qemu_QueryContextAttributesA,
    qemu_QueryContextAttributesW,
    qemu_QueryCredentialsAttributesA,
    qemu_QueryCredentialsAttributesW,
