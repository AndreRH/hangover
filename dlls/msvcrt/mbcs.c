...
unsigned char* CDECL __p__mbctype(void)
{
    ...
    return (unsigned char *)call.super.iret;
}
...
{
    struct qemu___p__mbctype *c = (struct qemu___p__mbctype *)call;
...
{
    struct qemu___p___mb_cur_max *c = (struct qemu___p___mb_cur_max *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu____mb_cur_max_func *c = (struct qemu____mb_cur_max_func *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu____mb_cur_max_l_func *c = (struct qemu____mb_cur_max_l_func *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__setmbcp *c = (struct qemu__setmbcp *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__getmbcp *c = (struct qemu__getmbcp *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsnextc *c = (struct qemu__mbsnextc *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbctolower *c = (struct qemu__mbctolower *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbctoupper *c = (struct qemu__mbctoupper *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbctombb *c = (struct qemu__mbctombb *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbcjistojms *c = (struct qemu__mbcjistojms *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbcjmstojis *c = (struct qemu__mbcjmstojis *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsdec *c = (struct qemu__mbsdec *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbclen *c = (struct qemu__mbclen *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsinc *c = (struct qemu__mbsinc *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsninc *c = (struct qemu__mbsninc *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbslen *c = (struct qemu__mbslen *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbccpy *c = (struct qemu__mbccpy *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsncpy *c = (struct qemu__mbsncpy *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsnbcpy_s_l *c = (struct qemu__mbsnbcpy_s_l *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsnbcpy_s *c = (struct qemu__mbsnbcpy_s *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbscpy_s_l *c = (struct qemu__mbscpy_s_l *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbscpy_s *c = (struct qemu__mbscpy_s *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsnbcpy *c = (struct qemu__mbsnbcpy *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbscmp *c = (struct qemu__mbscmp *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsnbicoll_l *c = (struct qemu__mbsnbicoll_l *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsicoll_l *c = (struct qemu__mbsicoll_l *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsnbicoll *c = (struct qemu__mbsnbicoll *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsicoll *c = (struct qemu__mbsicoll *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsnbcoll_l *c = (struct qemu__mbsnbcoll_l *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbscoll_l *c = (struct qemu__mbscoll_l *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsnbcoll *c = (struct qemu__mbsnbcoll *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbscoll *c = (struct qemu__mbscoll *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsicmp *c = (struct qemu__mbsicmp *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsncmp *c = (struct qemu__mbsncmp *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsnbcmp *c = (struct qemu__mbsnbcmp *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsnicmp *c = (struct qemu__mbsnicmp *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsnbicmp *c = (struct qemu__mbsnbicmp *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbscat *c = (struct qemu__mbscat *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbscat_s_l *c = (struct qemu__mbscat_s_l *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbscat_s *c = (struct qemu__mbscat_s *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbscpy *c = (struct qemu__mbscpy *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsstr *c = (struct qemu__mbsstr *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbschr *c = (struct qemu__mbschr *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsrchr *c = (struct qemu__mbsrchr *)call;
    WINE_FIXME("Unverified!\n");
...
unsigned char* CDECL _mbstok_s_l(unsigned char *str, const unsigned char *delim, unsigned char **ctx, MSVCRT__locale_t locale)
{
    ...
    call.str = (uint64_t)str;
    call.delim = (uint64_t)delim;
    call.ctx = (uint64_t)ctx;
    call.locale = (uint64_t)locale;
...
{
    struct qemu__mbstok_s_l *c = (struct qemu__mbstok_s_l *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbstok_s *c = (struct qemu__mbstok_s *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbstok_l *c = (struct qemu__mbstok_l *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbstok *c = (struct qemu__mbstok *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbbtombc *c = (struct qemu__mbbtombc *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbbtype *c = (struct qemu__mbbtype *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbbkana *c = (struct qemu__ismbbkana *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbcdigit *c = (struct qemu__ismbcdigit *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbcgraph *c = (struct qemu__ismbcgraph *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbcalpha *c = (struct qemu__ismbcalpha *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbclower *c = (struct qemu__ismbclower *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbcupper *c = (struct qemu__ismbcupper *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbcsymbol *c = (struct qemu__ismbcsymbol *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbcalnum *c = (struct qemu__ismbcalnum *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbcspace *c = (struct qemu__ismbcspace *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbcprint *c = (struct qemu__ismbcprint *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbcpunct *c = (struct qemu__ismbcpunct *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbchira *c = (struct qemu__ismbchira *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbckata *c = (struct qemu__ismbckata *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbblead_l *c = (struct qemu__ismbblead_l *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbblead *c = (struct qemu__ismbblead *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbbtrail *c = (struct qemu__ismbbtrail *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbclegal *c = (struct qemu__ismbclegal *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbslead *c = (struct qemu__ismbslead *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__ismbstrail *c = (struct qemu__ismbstrail *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsbtype *c = (struct qemu__mbsbtype *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsset *c = (struct qemu__mbsset *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsnbset *c = (struct qemu__mbsnbset *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsnset *c = (struct qemu__mbsnset *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsnccnt *c = (struct qemu__mbsnccnt *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsnbcnt *c = (struct qemu__mbsnbcnt *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsnbcat *c = (struct qemu__mbsnbcat *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsnbcat_s *c = (struct qemu__mbsnbcat_s *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsncat *c = (struct qemu__mbsncat *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbslwr *c = (struct qemu__mbslwr *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbslwr_s *c = (struct qemu__mbslwr_s *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsupr *c = (struct qemu__mbsupr *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsupr_s *c = (struct qemu__mbsupr_s *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsspn *c = (struct qemu__mbsspn *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsspnp *c = (struct qemu__mbsspnp *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbscspn *c = (struct qemu__mbscspn *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbsrev *c = (struct qemu__mbsrev *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbspbrk *c = (struct qemu__mbspbrk *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_mblen *c = (struct qemu_mblen *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_mbrlen *c = (struct qemu_mbrlen *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbstrlen_l *c = (struct qemu__mbstrlen_l *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbstrlen *c = (struct qemu__mbstrlen *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_mbtowc_l *c = (struct qemu_mbtowc_l *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_mbtowc *c = (struct qemu_mbtowc *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_mbrtowc *c = (struct qemu_mbrtowc *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbstowcs_l *c = (struct qemu__mbstowcs_l *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbstowcs_s_l *c = (struct qemu__mbstowcs_s_l *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbstowcs_s *c = (struct qemu__mbstowcs_s *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_mbsrtowcs *c = (struct qemu_mbsrtowcs *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu_mbsrtowcs_s *c = (struct qemu_mbsrtowcs_s *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbctohira *c = (struct qemu__mbctohira *)call;
    WINE_FIXME("Unverified!\n");
...
{
    struct qemu__mbctokata *c = (struct qemu__mbctokata *)call;
    WINE_FIXME("Unverified!\n");
